...
void mem_init(void) {
  ...
  // Written Questions 1
  // cprintf("Entry 1023: 0x%x\n", PTE_ADDR(*pgdir_walk(kern_pgdir, (const void
  // *)(uintptr_t) 0xFFC00000, 0))); extern char end[]; cprintf("%x\n",
...
void page_init(void) {
  ...
  // in use page 0
  // free blue part
  // in use green part until free physical memory
  size_t i;
